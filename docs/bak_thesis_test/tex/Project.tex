...
%% \subsubsection{Kinematic model for human pose}

%% Now that we have our values for the lengths of all limbs, we fit the model to our data using inverse kinematics for the parts of the body that are either not observed, or does not fit our data well.
